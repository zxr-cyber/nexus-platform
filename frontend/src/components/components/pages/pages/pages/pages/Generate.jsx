  ...
  return (
    <div>
      ...
      <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6">
        ...
        <button onClick={handleGenerate} disabled={loading} className="mt-4 w-full py-3 bg-pink-600 rounded-xl hover:bg-pink-700 transition">{loading ? 'Generating...' : 'Generate & Deploy'}</button>
