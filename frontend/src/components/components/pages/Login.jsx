    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-[#0a0a0f]">
      <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 max-w-md w-full">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button type="submit" className="w-full py-3 bg-pink-600 rounded-xl hover:bg-pink-700 transition">Sign In</button>
        </form>
        <p className="text-center text-gray-400 mt-4">Don't have an account? <Link to="/register" className="text-pink-500">Register</Link></p>
      </div>
    </div>
  );
}
